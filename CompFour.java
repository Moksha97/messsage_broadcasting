...
public class CompFour {
    ...
    public void start() {
        try{
            System.out.println("Client: Connecting to CompOne: 10.176.69.32  on port 9951." );
            // connecting to CompOne.
            client1 = new Socket("10.176.69.32", 9951);
            System.out.println("Client: Just connected to " + client1.getRemoteSocketAddress());
            connectedClientsCount++;
            // connecting to CompTwo.
            System.out.println("Client: Connecting to CompTwo: 10.176.69.33 on port 9953." );
            client2 = new Socket("10.176.69.33", 9953);
            System.out.println("Client: Just connected to " + client2.getRemoteSocketAddress());
            connectedClientsCount++;
            // connecting to CompThree.
            System.out.println("Client: Connecting to CompThree: 10.176.69.34 on port 9954.");
            client3 = new Socket("10.176.69.34", 9954);
            System.out.println("Client: Just connected to " + client3.getRemoteSocketAddress());
            connectedClientsCount++;
            ...
            out1.writeUTF("compFour ready");
            out2.writeUTF("compFour ready");
            out3.writeUTF("compFour ready");
            System.out.println("Client: Sent ready message to CompOne, CompTwo and CompThree.");
            ...
            if(allConnectedClientsCount == 4) {
                ...
                new CompTwoClientHandler(client1, client2, client3).start();
            }
    ...
    private class CompTwoClientHandler extends Thread {
        private Socket client1;
        private Socket client2;
        private final Socket client3;
        final ReentrantLock vectorClock_lock = new ReentrantLock();
        public CompTwoClientHandler(Socket client1, Socket client2, Socket client3) {
    ...
    public static void main(String[] args) {
        CompFour compFour = new CompFour();
        compFour.start();
    }
}